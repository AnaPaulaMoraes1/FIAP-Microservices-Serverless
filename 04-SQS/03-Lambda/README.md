...
1. No terminal do IDE criado no codespaces execute o comando `cd /workspaces/FIAP-Microservices-Serverless/04-SQS/03-Lambda/` para entrar na pasta que fara este exercicio.
