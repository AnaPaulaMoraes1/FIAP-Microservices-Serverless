...
1. No terminal do IDE criado no codespaces execute o comando `cd /workspaces/FIAP-Microservices-Serverless/04-SQS/02-DLQ/` para entrar na pasta que fara este exercicio.
